...
namespace implemented
{
	...
	public:
		...
		void TranslateRight(float distance)
		{
			...
			glm::vec3 directie = glm::normalize(glm::vec3(right.x, 0, right.z));
			position += directie * distance;
		...
		void RotateFirstPerson_OX(float angle)
		{
			...
			glm::vec4 tmp = glm::rotate(glm::mat4(1), angle, right) * glm::vec4(forward, 0);
		...
		void RotateFirstPerson_OY(float angle)
		{
			...
			// vectors!
			glm::vec4 tmp = glm::rotate(glm::mat4(1), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 0);
			forward = glm::normalize(glm::vec3(tmp));

			tmp = glm::rotate(glm::mat4(1), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 0);
		...
		void RotateFirstPerson_OZ(float angle)
		{
			...
			glm::vec4 tmp = glm::rotate(glm::mat4(1.f), angle, forward) * glm::vec4(right, 1);
			right = glm::normalize(glm::vec3(tmp));
			up = glm::cross(right, forward);
