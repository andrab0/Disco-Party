...
void Lab2::Init()
{
    ...
    // by definition!

         {
            ...
            meshes["tetraedru"] = new Mesh("tetr");
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(4, 5, 6), glm::vec3(0.75f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetraedru"], shaders["VertexColor"], glm::vec3(-3, -5, -1), glm::vec3(0.5f));


    // TODO(student): Draw the square
    RenderMesh(meshes["patrat"], shaders["VertexColor"], glm::vec3(0, 5, 1), glm::vec3(0.6f));
